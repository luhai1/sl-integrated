...
import com.sl.oauth2.constants.JwtOauthConstant;
...
public class JWTAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    private UsernamePasswordAuthenticationToken getAuthentication(String tokenHeader) throws ParseException, JOSEException {
        ...
        //获取载体中的数据
        Object account = jwt.getJWTClaimsSet().getClaim(JwtOauthConstant.LOGIN_USER);
        if (account != null){
            LoginUser user = JSONObject.parseObject(account.toString(), LoginUser.class);
