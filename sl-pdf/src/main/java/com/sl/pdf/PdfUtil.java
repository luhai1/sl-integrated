...
public class PdfUtil {
    ...
    public static void generateToPdf(PdfData pdfData, HttpServletResponse response){
        ...
        try {
            ...
            if(CollectionUtils.isNotEmpty(pdfData.getPdfFtlDataList())){
                ...
                throw new RuntimeException("pdf template is empty!");
            }
     ...
     */
    private   static void setWaterMark(PdfContentByte waterContent , WaterMark waterMark) throws IOException, DocumentException {
     ...
     */
     private static void setImageWater(PdfContentByte pdfContentByte,WaterImage waterImage) throws DocumentException, IOException {
